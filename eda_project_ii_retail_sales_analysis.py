...
def load_data():
    df = pd.read_csv("https://github.com/MuhammadFurqanMohsin25Apr/Streamlit-Deployed-Retail-Sales-Analysis/raw/refs/heads/main/Online_Retail.csv",encoding='ISO-8859-1')
